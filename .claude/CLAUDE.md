...
### Code health
Three co-equal signals: code health 7.26/10 avg (Good), hotspot health 5.49/10 (stable), worst `lib/plant-roles.js` at 2.32/10 · maintainability 8.19/10 · performance risk 44 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.

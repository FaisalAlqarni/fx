...
| 28 | Model routing that a controller cannot quietly skip | 27 | Claude Code tier mapping; standard-tier default; stated reason for Opus; cheapest-tier safety; babysitter rule | Amendment 2 |

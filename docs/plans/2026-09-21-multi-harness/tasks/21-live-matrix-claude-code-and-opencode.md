...
- [ ] From the delta coverage audit: on the final tree, row 04 passes at least 8 of 10 on opencode and 5 of 5 on Claude Code, the lane-triggering prompts hit at least as often as S3 did (9 of 9 on each runtime), and rows 02 and 16 PASS on opencode
- [ ] The part-order criterion is n/a (ruling of 2026-09-22): the preamble is a single part since task 25

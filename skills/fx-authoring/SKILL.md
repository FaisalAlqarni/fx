...
description: >
  ...
  does X instead of Y", "this prompt isn't working", "add this to CLAUDE.md".
  Covers wording that changes agent behavior, not prose for humans.
---
...
enforceable.** If a regex, a linter or a hook can enforce it, automate it —
documentation is for judgment calls.

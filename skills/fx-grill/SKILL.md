...
name: fx-grill
description: >
  Stress-test a decision that is not heading for code: the grilling interview standalone, no classification, no design doc, no gate
argument-hint: [topic]
disable-model-invocation: true
# generated by scripts/gen-command-skills from commands/fx-grill.md: edit there, not here
---

...
decision tree with them: 2 to 4 related questions per round, a recommendation on
...
`../../references/vocab/codebase-design.md`: parallel sub-agents each design a **radically different** interface under a

...
### Code health
Three co-equal signals: code health 7.2/10 avg (Good), hotspot health 5.2/10 (stable), worst `lib/plant-roles.js` at 2.32/10 · maintainability 8.06/10 · performance risk 44 open static I/O-in-loop / N+1 findings. Detail: `get_health()`.
...
- `lib/plant-roles.test.js` — change entropy — impact −1.8
- `lib/preamble.test.js` — prior defect — impact −1.8

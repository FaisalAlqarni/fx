...
check(true, `${G} push`, WT, 'bare push from worktree');
...
check(false, `${G} push origin feature`, MAIN, 'push from main checkout still blocked');
check(false, `${G} commit -m x`, MAIN, 'commit on main still blocked');

...
inherits the session's model — usually the most capable and most expensive —
which silently defeats everything below.
...
the cheapest models routinely take 2–3× the turns on multi-step work — costing
more overall.
